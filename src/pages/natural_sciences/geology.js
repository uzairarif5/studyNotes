...
<div className="content">
	<div style={{width: "49%",float: "left", marginLeft: "0.5%"}}>
		...
		<ul>
			...
			<li><ImgComp src={require("./geologyPics/8.png")} style={{width:"70%"}}/></li>
		...
		<ul>
			...
			<li><ImgComp src={require("./geologyPics/9.png")} style={{width:"70%"}}/></li>
			...
			<li>Most partial melting of real rock does not involve heating the rock up. The two main mechanisms through which rocks melt are <b>decompression melting</b> and <b>flux melting</b>:<SubList>
				...
				<li><ImgComp src={require("./geologyPics/10.png")} style={{width: "90%"}}/></li>
			</SubList></li>
			...
			<li><ImgComp src={require("./geologyPics/11.png")} style={{width: "100%"}}/></li>
	...
	<div style={{width: "49%",float: "right",marginRight: "0.5%"}}>
		...
		<ul>
			<li>The minerals that make up igneous rocks crystallize at a range of different temperatures. The sequence in which minerals crystallize from a magma is known as the <b>Bowen reaction series</b>:<SubList>
				...
				<li><ImgComp src={require("./geologyPics/12.png")} width="90%"/></li>
				...
				<li><ImgComp src={require("./geologyPics/13.png")} width="90%"/></li>
			</SubList></li>
			<li>A number of processes that take place within a magma chamber can affect the types of rocks produced in the end:<SubList>
				...
				<li><ImgComp src={require("./geologyPics/14.png")} width="90%"/></li>
		...
		<ul>
			...
			<li><figure>
				<ImgComp src={require("./geologyPics/15.png")} style={{width: "100%"}}/>
		...
		<ul>
			...
			<li><figure>
				<ImgComp src={require("./geologyPics/16.png")} style={{width:"70%"}}/>
...
<div className="content">
	<div style={{width: "49%",float: "left", marginLeft: "0.5%"}}>
		...
		<ul>
			...
			<li>
				...
				<ImgComp src={require("./geologyPics/1.png")} style={{objectFit: "contain", maxWidth: "100%", maxHeight: "250px"}} />
				</div>
			</li>
			...
			<li><ImgComp src={require("./geologyPics/2.png")} style={{width: "80%"}} /></li>
			...
			<li>
				...
				<ImgComp src={require("./geologyPics/3.png")} style={{maxWidth: "100%"}}/>

				</div>
			</li>
			<li>
				<figure>
					<ImgComp src={require("./geologyPics/4.png")} style={{width: "100%"}}/>
		...
		<ul>
			...
			<li><ImgComp src={require("./geologyPics/5.png")} width="90%"/></li>
	...
	<div style={{width: "49%",float: "right",marginRight: "0.5%"}}>
		...
		<ul>
			<li><ImgComp src={require("./geologyPics/6.png")} width="90%"/></li>
		...
		<ul>
			...
			<li><ImgComp src={require("./geologyPics/7.png")} width="80%"/></li>
