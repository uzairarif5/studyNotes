...
<div className="content">
	<div style={{width: "49%",float: "left",marginLeft: "0.5%"}}>
		<ul>
			<li><figure>
				<ImgComp src={require("./meteorologyPics/1.png")} style={{width:"70%"}}/>
			...
			<li><figure>
				<ImgComp src={require("./meteorologyPics/2.png")} style={{width:"70%"}}/>
			...
			<li><ImgComp src={require("./meteorologyPics/3.PNG")} style={{width:"60%"}}/></li>
	...
	<div style={{width: "49%",float: "right",marginRight: "0.5%"}}>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/4.png")} style={{width:"90%"}}/></li>
			...
			<li><ImgComp src={require("./meteorologyPics/5.jpg")} style={{width:"80%"}}/></li>
		</ul>
...
<div className="content">
	<div style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/6.png")} style={{width:"90%"}}/></li>
		</ul>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/7.png")} style={{width:"70%"}}/></li>
	...
	<div style={{width: "49%",marginRight: "0.5%",float: "right"}}>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/8.png")} style={{width:"90%"}}/></li>
		...
		<ul>
			...
			<li><figure>
				<ImgComp src={require("./meteorologyPics/9.png")} style={{width:"90%"}}/>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/10.gif")} style={{width:"60%"}}/></li>
			<li>While it is true that Earth's orbit is not spherical, and it is closer to the Sun during Northern Hemisphere winter, the distance from Earth to the Sun is not the cause of seasons.<SubList>
				<li><ImgComp src={require("./meteorologyPics/11.jpg")} style={{width:"70%"}}/></li>
			</SubList></li>
			<li><figure>
				<ImgComp src={require("./meteorologyPics/12.png")} style={{width:"70%"}}/>
...
<div className="content">
	<div style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/13.png")} style={{width:"70%"}}/></li>
			<li><figure>
				<ImgComp src={require("./meteorologyPics/14.png")} style={{width:"80%"}}/>
	...
	<div style={{width: "49%",marginRight: "0.5%",float: "right"}}>
		...
		<ul>
			...
			<li><ImgComp src={require("./meteorologyPics/15.png")} style={{width: "50%"}}/></li>
		...
		<ul>
			...
			<li><figure>
				<ImgComp src={require("./meteorologyPics/16.png")} style={{width:"60%"}}/>
