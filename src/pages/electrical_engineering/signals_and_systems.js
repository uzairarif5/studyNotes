		...
		<div style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			...
			<ul data-source={2}>
				<li>Structure of Communication Systems:<SubList>
					<li><ImgComp src={require("./signals_and_systems_pics/1.PNG")} style={{width:"80%"}}/></li>
				...
				<li>Interconnection of Systems:<SubList>
					...
					<li><ImgComp src={require("./signals_and_systems_pics/2.png")} style={{width:"70%"}}/></li>
					...
					<li><ImgComp src={require("./signals_and_systems_pics/3.png")} style={{width:"70%"}}/></li>
					<li><b>Feedback:</b></li>
					<li><ImgComp src={require("./signals_and_systems_pics/4.png")} style={{width:"70%"}}/></li>
				</SubList></li>
