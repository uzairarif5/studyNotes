...
export default function ContactComp() {
  const dialogRef: React.RefObject<null| HTMLDialogElement> = useRef(null);
  const [submissionState, changeSS] = useState(NOT_SUBMITTING);
  var formCounterVal = useSelector((state: StateType) => state.formCounter); //variable not needed, only rerender
