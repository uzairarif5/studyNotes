...
said to <b>overflow</b>.</li>
          ...
          <li><ImgComp src={"/articlePics/information_and_entropy_pics/1.png"} style={{width:"90%"}}/></li>
        </SubList></li>
...
them to letters, spaces, and punctuation.</li>
          <li><ImgComp src={"/articlePics/information_and_entropy_pics/2.png"} style={{width:"90%"}}/></li>
...
transmission, storage, or processing.</li>
        <li><ImgComp src={"/articlePics/information_and_entropy_pics/3.png"} style={{width:"100%"}}/></li>
      </ul>
    </div>
		<div data-source={40} style={{width: "49%",marginRight: "0.5%",float: "right"}}>
      <ul>
...
Abraham Lempel, Jacob Ziv, and Terry Welch.</li>
          <li><u>Example:</u><SubList>
            ...
            <li><ImgComp src={"/articlePics/information_and_entropy_pics/4.png"} style={{width:"100%"}}/></li>
  ...
  <div className="content">
      ...
      <ul>
        ...
        <li><ImgComp src={"/articlePics/information_and_entropy_pics/5.png"} style={{width:"100%"}}/></li>
      </ul>
    </div>
		<div data-source={40} style={{width: "49%",marginRight: "0.5%",float: "right"}}>
      <ul>
