...
computers can talk to each other.</li>
      ...
      <ImgComp src={"/articlePics/networking_pics/1.png"} style={{width:"70%"}}/>
	  </div>
  </div>
...
moving data from one computer to another can be ignored.</li>
	  ...
	  <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={59}>
      <ImgComp src={"/articlePics/networking_pics/2.png"} style={{width:"25%"}}/>
    </div>
  </div>
  ...
  <div className="content">
	  ...
	  <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={59}>
      <figure>
        <ImgComp src={"/articlePics/networking_pics/3.png"} style={{width:"60%"}}/>
  ...
  <div className="content">
    <ul style={{width: "49%",float: "left",marginLeft: "0.5%", marginRight: "0.5%"}} data-source={59}>
      ...
      <li>The Transport Layer In Operation:<SubList>
        ...
        <li><ImgComp src={"/articlePics/networking_pics/5.png"} style={{width:"80%"}}/></li>
    ...
    <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={59}>
      <figure>
        <ImgComp src={"/articlePics/networking_pics/4.png"} style={{width:"50%"}}/>
...
S: A142 OK [READ-WRITE] SELECT completed
      ...
      <li>Flow Control:<SubList>
        ...
        <li><ImgComp src={"/articlePics/networking_pics/6.png"} style={{width:"80%"}}/></li>
...
mysock.close()
    ...
    <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={59}>
      <ImgComp src={"/articlePics/networking_pics/7.png"} style={{width:"50%"}}/>
    </div>
  </div>
  ...
  <div className="content">
    ...
    <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={59}>
      <ImgComp src={"/articlePics/networking_pics/8.png"} style={{width:"50%"}}/>
    </div>
  </div>
  ...
  <div className="content">
    ...
    <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={59}>
      <figure>
        <ImgComp src={"/articlePics/networking_pics/9.png"} style={{width:"70%"}}/>
