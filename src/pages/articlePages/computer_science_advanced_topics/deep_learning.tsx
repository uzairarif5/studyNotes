	...
	<div className="content">
		...
		<div data-source={8} style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			<ul>
				...
				<li><ImgComp src={"/articlePics/deep_learning_pics/1.png"} style={{width:"100%"}}/></li>
			</ul>
		</div>
	</div>
			...
			<div data-source={9}>
				...
				<ul>
						...
						<li>We can find the optimal parameters (as assessed on the training data) analytically by applying a simple formula as follows:<SubList>
							...
							<li className="ownExplanation"><ImgComp src={"/articlePics/deep_learning_pics/15.jpg"} width="90%"/></li>
	...
	<div className="content">
		<div style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			<ul data-source={8}>
				<li>A single neuron in a neural network is called the <b>perceptron</b>:<SubList>
					<li><ImgComp src={"/articlePics/deep_learning_pics/2.png"} style={{width:"100%"}}/></li>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/3.png"} style={{width:"50%%"}}/></li>
					...
					<li>Multi output Preceptron:<SubList>
						<li><ImgComp src={"/articlePics/deep_learning_pics/4.png"} style={{width:"60%"}}/></li>
				...
				<li>Neural network:<SubList>
					<li><ImgComp src={"/articlePics/deep_learning_pics/5.png"} style={{width:"60%"}}/></li>
					<li>You can create a deeper neural network by having many hidden layers.</li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/6.png"} style={{width:"70%"}}/></li>
					<li><b>Empirical loss</b> measures the total loss over our entire dataset.</li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/7.png"} style={{width:"70%"}}/></li>
					<li><b>Mean squared error loss:</b></li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/8.png"} style={{width:"70%"}}/></li>
					<li><b>Cross entropy loss:</b></li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/9.png"} style={{width:"80%"}}/></li>
					<li>We want to find weights that minimize our loss:</li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/10.png"} style={{width:"70%"}}/></li>
				</SubList></li>
				<li>Gradient descent:<SubList>
					<li><ImgComp src={"/articlePics/deep_learning_pics/11.gif"} style={{width:"100%"}}/></li>
				...
				<li>Backpropagation:<SubList>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/12.png"} style={{width:"100%"}}/></li>
				...
				<li><b>Overfitting:</b><SubList>
					<li><ImgComp src={"/articlePics/deep_learning_pics/13.png"} style={{width:"100%"}}/></li>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/14.png"} style={{width:"90%"}}/></li>
		...
		<ul data-source={8} style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			...
			<li><b>Recurrent Neural Networks:</b><SubList>
				...
				<li><ImgComp src={"/articlePics/deep_learning_pics/18.png"} width="90%"/></li>
				...
				<li><b>Long short-term memory:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/24.png"} width="90%"/></li>
					<li>LSTM modules contain computational blocks that control information flow:</li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/25.png"} width="90%"/></li>
	...
	<div className="content">
		<ul data-source={9} style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			<li>Hidden Layers:<SubList>
				...
				<figure>
					<ImgComp width="80%" src={"/articlePics/deep_learning_pics/16.jpg"}/>
			...
			<li>Activation Functions:<SubList>
				...
				<li>Sigmoid:<SubList>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/17.png"}/></li>
		...
		<ul data-source={8} style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			...
			<li>Learning visual features:<SubList>
				...
				<li>Using spatial structure:<SubList>
					...
					<li><ImgComp width="90%" src={"/articlePics/deep_learning_pics/26.png"}/></li>
					...
					<li>This "patchy" operation is <b>convolution</b>:<SubList>
						...
						<li><ImgComp width="95%" src={"/articlePics/deep_learning_pics/27.png"}/></li>
						<li>We slide the filter over the input image, element-wise multiply and add the output:</li>
						<li><ImgComp width="95%" src={"/articlePics/deep_learning_pics/28.gif"}/></li>
					</SubList></li>
				</SubList></li>
			</SubList></li>
			<li>Convolutional neural network:<SubList>
				...
				<li><figure>
					<ImgComp width="60%" src={"/articlePics/deep_learning_pics/29.png"}/>
				...
				<li><figure>
					<ImgComp width="80%" src={"/articlePics/deep_learning_pics/30.png"}/>
				...
				<li><ImgComp width="90%" src={"/articlePics/deep_learning_pics/31.png"}/></li>
				...
				<li><ImgComp width="90%" src={"/articlePics/deep_learning_pics/32.png"}/></li>
			</SubList></li>
			<li>Object detection with R-CNNs:<SubList>
				...
				<li><figure>
						<ImgComp width="90%" src={"/articlePics/deep_learning_pics/33.png"}/>
		...
		<ul data-source={8} style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			...
			<li>Latent Variable Models:<SubList>
				...
				<li><b>Autoencoders:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/34.png"} style={{width:"100%"}}/></li>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/35.png"} style={{width:"100%"}}/></li>
				</SubList></li>
				<li><b>Generative Adversarial Networks:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/36.png"} style={{width:"100%"}}/></li>
				</SubList></li>
			</SubList></li>
			<li><b>Reinforcement Learning:</b><SubList>
				...
				<li><ImgComp src={"/articlePics/deep_learning_pics/37.png"} style={{width:"100%"}}/></li>
				...
				<li><b>Value Learning:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/deep_learning_pics/39.png"} style={{width:"100%"}}/></li>
					<li>\({"Q"}\) learning cannot handle continous action spaces.</li>
				</SubList></li>
				<li><b>Policy Learning:</b><SubList>
					<li><ImgComp src={"/articlePics/deep_learning_pics/40.png"} style={{width:"100%"}}/></li>
					<li>This enables modelling continous action spaces.</li>
					<li><ImgComp src={"/articlePics/deep_learning_pics/41.png"} style={{width:"100%"}}/></li>
...
Increase the probability of actions that resulted in high reward
				...
				<li><ImgComp src={"/articlePics/deep_learning_pics/38.png"} style={{width:"100%"}}/></li>
			</SubList></li>
		</ul>
	</div>
	...
	<div className="content">
		<ul data-source={8} style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			...
			<li>Diffusion Models and Generative AI:<SubList>
				<li><ImgComp src={"/articlePics/deep_learning_pics/42.png"} style={{width:"100%"}}/></li>
			</SubList></li>
		</ul>
	</div>
</>
