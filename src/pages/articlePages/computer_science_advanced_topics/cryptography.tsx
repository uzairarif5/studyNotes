	  ...
	  <div style={{width: "49%",float: "left",marginLeft: "0.5%", marginRight: "0.5%"}}>
		  <ul data-source={61}>
				...
				<li>Secrets & Kerckhoff's Principle:<SubList>
				  ...
				  <li><ImgComp src={"/articlePics/cryptography_pics/1.png"} style={{width:"60%",marginLeft:"10%"}}/></li>
				</SubList></li>
				...
				<li>Specifics of <b>One-Time Pad</b>:<SubList>
				  ...
				  <li><ImgComp src={"/articlePics/cryptography_pics/2.png"} style={{width:"70%"}}/></li>
		...
		<div style={{width: "49%",float: "left",marginLeft: "0.5%", marginRight: "0.5%"}}>
				<ul>
						...
						<li><b>Caesar Cipher:</b><SubList>
							...
							<li><ImgComp src={"/articlePics/cryptography_pics/c4.jpg"} style={{width: "60%", marginLeft: "20%"}}/></li>
						</SubList></li>
						<li><b>Pigpen Cipher:</b><SubList>
							<li>Simple substitution cipher in which each letter is replaced with a graphical symbol.</li>
							<li><ImgComp src={"/articlePics/cryptography_pics/c5.jpg"} style={{width: "60%", marginLeft: "20%"}}/></li>
						</SubList> </li>
						<li><b>Polyalphabetic / Vigenere Cipher:</b><SubList>
							...
							<li><ImgComp src={"/articlePics/cryptography_pics/c6.jpg"} style={{width: "60%", marginLeft: "20%"}}/></li>
						</SubList></li>
		...
		<div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}}>
			<ul>
				<li><b>Rail Fence Cipher:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/cryptography_pics/c7.jpg"} style={{width: "60%", marginLeft: "20%"}}/></li>
				</SubList> </li>
			...
			<ul data-source={34}>
				<li><b>Rectangular Transposition:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/cryptography_pics/c20.jpg"} style={{width: "60%"}}/></li>
					...
					<li><ImgComp src={"/articlePics/cryptography_pics/c21.jpg"} style={{width: "60%"}}/></li>
	  ...
	  <div style={{width: "49%",float: "left",marginLeft: "0.5%", marginRight: "0.5%"}}>
		  <ul>           
			  <li>Symmetric Ciphers:<SubList>
				  ...
				  <li><ImgComp src={"/articlePics/cryptography_pics/c14.jpg"} style={{width: "60%", marginLeft: "20%"}}/></li>
  ...
  steps) each bit of the plaintext affects every bit of the ciphertext.</li>
			  ...
			  <li className="Opened">Asymmetric Ciphers:<SubList>
				  ...
				  <li>Public key is made public
					  ...
					  <li><ImgComp src={"/articlePics/cryptography_pics/c15.jpg"} style={{width: "100%"}}/></li>
					  <li><ImgComp src={"/articlePics/cryptography_pics/c16.jpg"} style={{width: "100%"}}/></li>
				  <li><b>Diffie-Hellman:</b><SubList>
					  ...
					  <li><ImgComp src={"/articlePics/cryptography_pics/c17.jpg"} style={{width: "100%"}}/></li>
				  </SubList></li>
				  <li><b>RSA:</b> Rivest, Shamir, Adleman:<SubList>
					  ...
					  <li><ImgComp src={"/articlePics/cryptography_pics/c19.jpg"} style={{width: "100%"}}/></li>
				  </SubList></li>
	  ...
	  <div style={{width: "49%",float: "right",marginLeft: "0.5%",marginRight: "0.5%"}} data-source={34}>
		  <ul>
			  <li><b>Primitive Roots:</b><SubList>
				  <li><ImgComp src={"/articlePics/cryptography_pics/c8.jpg"} style={{width:"80%",marginLeft:"10%"}}/></li>
				</SubList></li>
			  ...
			  <li><b>The Huffman tree:</b><SubList>
				  ...
				  <li><ImgComp src={"/articlePics/cryptography_pics/c11.jpg"} style={{width: "70%",marginLeft: "15%"}}/></li>
				  <li><ImgComp src={"/articlePics/cryptography_pics/c12.jpg"} style={{width: "70%",marginLeft: "15%"}}/></li>
				  <li>Since there are now three nodes of weight 5, we have a choice.</li> 
				  <li><ImgComp src={"/articlePics/cryptography_pics/c13.jpg"} style={{width: "70%",marginLeft: "15%"}}/></li>    
			  </SubList></li>
