	...
	<div className="content">
		<ul data-source={45} style={{width:" 49%",marginLeft: "0.5%",float: "left"}}>
			<li>Basic concepts:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/31.jpeg"} width="60%" /></li>
			</SubList></li>
			<li>Scalars:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/32.jpeg"} width="60%" /></li>
			</SubList></li>
			<li>Adding vectors:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/33.jpeg"} width="60%" /></li>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/34.jpeg"} width="60%" /></li>
			...
			<li>Three-dimensional rectangular coordinate:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/35.jpeg"} width="40%" /></li>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/36.jpeg"} width="40%" /></li>
		...
		<ul data-source={45} style={{width:" 49%",marginLeft: "0.5%",float: "right"}}>
			...
			<li>Cross product:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/40.jpeg"} width="70%" /></li>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/1.jpeg"} width="70%" /></li>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/41.jpeg"} width="70%" /></li>
			</SubList></li>
			...
			<li>Distance from a point to a line:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/37.jpeg"} width="60%" /></li>
			</SubList></li>
			...
			<li>Distance from a point to a plane:<SubList>
				...
				<li><ImgComp src={"/articlePics/vectors_pics/38.jpeg"} width="60%" /></li>
			</SubList></li>
			<li>Finding the angle between two intersecting planes:<SubList>
				<li><ImgComp src={"/articlePics/vectors_pics/39.jpeg"} width="50%" /></li>
