		...
		<div style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			<ul data-source={41}>
				<li><b>Pie chart:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/probability_and_statistics_pics/9.png"} width="50%"/></li>
				</SubList></li>
				<li><b>Scatter Plot:</b><SubList>
					...
					<li><u>Example:</u><SubList>
						...
						<li><ImgComp src={"/articlePics/probability_and_statistics_pics/8.png"} width="70%"/></li>
			...
			<ul>
				...
				<li><b>Box Plots:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/probability_and_statistics_pics/1.webp"} width="80%"/></li>
				</SubList></li>
				...
				<li>Skewness:<SubList>
					...
					<li><figure>
						<ImgComp src={"/articlePics/probability_and_statistics_pics/2.png"} width="60%"/>
					...
					<li><figure>
						<ImgComp src={"/articlePics/probability_and_statistics_pics/3.png"} width="60%"/>
				...
				<li>Standard deviation:<SubList>
					...
					<li>If the data sets have different means and standard deviations, then comparing the data values directly can be misleading. For each data value, calculate how many standard deviations away from its mean the value is:<SubList>
						...
						<li data-source={41}><ImgComp src={"/articlePics/probability_and_statistics_pics/10.png"} width="60%"/></li>
					</SubList></li>
		...
		<div style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			...
			<ul>
				...
				<li>Tree Diagrams:<SubList>
					...
					<li><ImgComp src={"/articlePics/probability_and_statistics_pics/4.png"} width="60%"/></li>
				...
				<li>Venn Diagram:<SubList>
					...
					<li><ImgComp src={"/articlePics/probability_and_statistics_pics/5.png"} width="60%"/></li>
				</SubList></li>
			</ul>
		</div>
	</div>
			...
			<ul>
				...
				<li><b>Uniform Distribution:</b><SubList>
					...
					<li><u>Example:</u><SubList>
						...
						<ImgComp src={"/articlePics/probability_and_statistics_pics/11.png"} width="80%"/>
	...
	<div className="content">
		<ul style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			<li>Linear Equations:<SubList>
				...
				<li><figure>
					<ImgComp src={"/articlePics/probability_and_statistics_pics/6.png"} width="100%"/>
			...
			<li>Linear regression:<SubList>
				<li><ImgComp src={"/articlePics/probability_and_statistics_pics/7.png"} width="70%"/></li>
