		...
		<div style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			<ul data-source={2}>
				...
				<li>Power Dissipation in Resistor Circuits:<SubList>
					...
					<li><ImgComp src={"/articlePics/signals_and_systems_pics/5.png"} style={{width:"50%"}}/></li>
				...
				<li>Series and Parallel Circuits:<SubList>
					...
					<li><ImgComp src={"/articlePics/signals_and_systems_pics/6.png"} style={{width:"60%"}}/></li>
					<li>When resistors are connected in parallel, the voltages are identical.</li>
					<li><ImgComp src={"/articlePics/signals_and_systems_pics/7.png"} style={{width:"60%"}}/></li>
					...
					<li><ImgComp src={"/articlePics/signals_and_systems_pics/8.png"} style={{width:"60%"}}/></li>
					<MathStuff>$$ {"\\begin{align} \
					i_{out} &= \\frac{R_1}{R_1+R_2} i_{in}\\\\\
					V &= i_{in}R_{total}\\\\\
					...
					<li><ImgComp src={"/articlePics/signals_and_systems_pics/10.png"} style={{width:"30%"}}/></li>
		...
		<div style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			<ul data-source={2}>
				<li>Circuits with Capacitors:<SubList>
					<li><ImgComp src={"/articlePics/signals_and_systems_pics/9.png"} style={{width:"40%"}}/></li>
				...
				<li>The Impedance Concept:<SubList>
					...
					<li><figure>
						<ImgComp src={"/articlePics/signals_and_systems_pics/11.png"} style={{width:"60%"}}/>
