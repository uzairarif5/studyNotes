	...
	<div className="content">
		...
		<ul style={{width: "49%",marginRight: "0.5%",float: "right"}}>
			<li><b>Polarization:</b><SubList>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/3.png"}/></li>
				...
				<li><figure>
					<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/4.png"} style={{width:"70%"}}/>
				...
				<li><figure>
					<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/7.webp"} style={{width:"55%"}}/>
			...
			<li><b>Electric Field:</b><SubList>
				...
				<li><figure>
					<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/5.webp"} style={{width:"60%"}}/>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/6.webp"} style={{width:"40%"}}/></li>
			...
			<li><b>Electric Potential:</b><SubList>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/8.webp"} style={{width:"40%"}}/></li>
				...
				<li>Relationship between voltage and electric field:<SubList>
					...
					<li><figure>
						<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/9.webp"} style={{width:"40%"}}/>
				...
				<li><figure>
					<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/10.webp"} style={{width:"50%"}}/>
			...
			<li><b>Capacitors:</b><SubList>
				...
				<li><b>Parallel Plate Capacitor:</b><SubList>
					...
					<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/11.webp"} style={{width:"40%"}}/></li>
				...
				<li>Capacitors in series:<SubList>
					<li><figure>
						<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/12.png"} style={{width:"70%"}}/>
				...
				<li>Capacitors in parallel:<SubList>
					<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/13.webp"} style={{width:"70%"}}/></li>
	...
	<div className="content">
		<ul style={{width: "49%",marginLeft: "0.5%",float: "left"}}>
			<li><b>Electric current:</b><SubList>
				...
				<li><figure>
					<ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/15.webp"} style={{width:"50%"}}/>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/14.png"} style={{width:"70%"}}/></li>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/16.webp"} style={{width:"60%"}}/></li>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/17.webp"} style={{width:"50%"}}/></li>
			...
			<li><b>Resistance:</b><SubList>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/18.webp"} style={{width:"40%"}}/></li>
				...
				<li><ImgComp src={"/articlePics/electricity_magnetism_and_circuits_pics/19.webp"} style={{width:"50%"}}/></li>
