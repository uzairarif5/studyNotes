...
<div className="content">
  <ul data-source={65} style={{width:" 49%",marginLeft: "0.5%",float: "left"}}>
    ...
    <li>Polar coordinates:<SubList>
      ...
      <ImgComp src={require("./calculus_advanced_pics/2.png")} width="40%"/>
    ...
    <li>Curves defined by polar equations:<SubList>
      <ImgComp src={require("./calculus_advanced_pics/4.png")} width="90%"/>
      <ImgComp src={require("./calculus_advanced_pics/5.png")} width="90%"/>
    ...
    <li>Symmetry in Polar Curves and Equations:<SubList>
      ...
      <ImgComp src={require("./calculus_advanced_pics/6.png")}  width="90%"/>
    </SubList></li>
  ...
  <ul data-source={45} style={{width:" 49%",marginRight: "0.5%",float: "right"}}>
    <li><b>Cylindrical coordinate system:</b><SubList>
      ...
      <ImgComp src={require("./calculus_advanced_pics/1.jpeg")} width="50%"/>
      ...
      <figure>
        <ImgComp src={require("./calculus_advanced_pics/7.jpeg")} width="80%"/>
    ...
    <li><b>Spherical Coordinates:</b><SubList>
      ...
      <ImgComp src={require("./calculus_advanced_pics/3.jpeg")} width="50%"/>
      ...
      <figure>
        <ImgComp src={require("./calculus_advanced_pics/8.jpeg")} width="80%"/>
