...
export const content = [
	...
	<>
		...
		<GraphBox src={require("./probability_and_statistics_worksheet_pics/1.png")}/>
		...
		<GraphBox src={require("./probability_and_statistics_worksheet_pics/2.png")}/>
		...
		<GraphBox src={require("./probability_and_statistics_worksheet_pics/3.png")}/>
		...
		<GraphBox src={require("./probability_and_statistics_worksheet_pics/5.png")} style={{height:"200px"}}/>
		...
		<p className="boxAnswer">
			...
			<img src={require("./probability_and_statistics_worksheet_pics/4.png")} alt="" style={{height:"80px"}}/>
		</p>
		<h2>Calculations</h2>
